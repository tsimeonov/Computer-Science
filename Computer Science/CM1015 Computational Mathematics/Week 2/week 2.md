...
1. `1 + 0 = 1`
1. `0 + 1 = 1`
1. `1 + 1 = 10` (This is the key! The value "two" in binary is written `10`. So, you write 0 and carry the 1 to the next column)
1. `1 + 1 + 1 = 1` (this happens when yiu add a `carry` bit; the sum is 1 and you carry a 1)
