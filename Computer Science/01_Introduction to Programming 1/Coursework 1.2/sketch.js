...
function draw() {
  ...
  if (!collectable.isFound) {
    ...
    fill(255, 255, 255);
    textSize(20);
    text("C", collectable.x_pos - 5, collectable.y_pos + 5);
  }
  ...
  if (gameChar_x <= 377 && gameChar_x >= 322 && gameChar_y >= floorPos_y) {
    // isPlummeting = true;
    console.log("in");
  }
...
function keyPressed() {
  if (!isPlummeting) {
    if (keyCode == 37) {
      console.log("canyounX " + canyon.x_pos);
      console.log("canyoun width " + canyon.width);
