...
Stands for Exclusive OR (often abbreviated as XOR).
...
In plain English, it means that $p$ and $q$ are completely dependent on each other—they must be exactly the same.
Here are the rules for how it evaluates:
