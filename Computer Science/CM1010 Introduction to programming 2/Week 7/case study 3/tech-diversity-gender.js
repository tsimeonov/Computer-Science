  ...
  this.draw = function () {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var company = {
        ...
        name: this.data.getString(i, "company") || "", // Handle undefined gracefully.
        female: this.data.getNum(i, "female") || 0, // Handle undefined gracefully.
        male: this.data.getNum(i, "male") || 0, // Handle undefined gracefully.
      };
      ...
      rect(
        this.layout.leftMargin + this.mapPercentToWidth(company.female), // Adjust for female width
        lineY,
    ...
    stroke(150);
    strokeWeight(1);
    line(this.midX, this.layout.topMargin, this.midX, height);
  };
